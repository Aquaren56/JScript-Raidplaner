...
export const isPlayer = makeObjectTest<Player>(
  ObjectType.Player,
  ObjectType.pld,
  ObjectType.war,
  ObjectType.drk,
...
export const isTank = makeObjectTest<Player>(
  ObjectType.pld,
  ObjectType.war,
  ObjectType.drk,
  ObjectType.gnb
...
export const isHealer = makeObjectTest<Player>(
  ObjectType.whm,
  ObjectType.sch,
  ObjectType.ast,
  ObjectType.sge
...
export const isDps = makeObjectTest<Player>(
  ObjectType.mnk,
  ObjectType.drg,
  ObjectType.nin,
  ObjectType.sam,
