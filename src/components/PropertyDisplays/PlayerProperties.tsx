...
export default function ItemForm({
  ...
  const updateChildren = () => {
    player.children.forEach((child) => {
      if (isTopping(child)) {
        child.drawRotPoint = {
          x: player.drawRotPoint.x,
          y: player.drawRotPoint.y - player.size.y - child.drawOffset.y,
        };
      } else {
        child.drawRotPoint = {
          x: player.drawRotPoint.x,
          y: player.drawRotPoint.y - player.size.y,
        };
      }
    });
  };
